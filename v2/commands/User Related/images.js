    ...
    async function b(){
        const outputBuffer = await svg2png({
          ...
          <g id="template" transform="translate(-208 -209)">
            ...
            <text id="_usr_" data-name="${message.author.username}" transform="translate(326 286)" fill="#fff" font-size="20" font-family="SegoeUI, Segoe UI"><tspan x="0" y="0">Hello ${name}</tspan></text>
